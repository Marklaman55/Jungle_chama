      ...
      <AnimatePresence>
        {showProductDetails && selectedProduct && (
          ...
          >
            ...
            >
              <div className="md:w-3/5 bg-gray-100 relative group/media">
                ...
                <button 
                  ...
                  className="absolute top-6 left-6 w-12 h-12 bg-white/90 backdrop-blur rounded-full flex items-center justify-center text-black shadow-xl hover:scale-110 transition-all z-20"
                >
